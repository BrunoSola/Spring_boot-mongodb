...
public class Instantiation implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        maria.getPosts().addAll(Arrays.asList(post1,post2)); // Referenciando os post para o User Maria.
        userRepository.save(maria); // Salvando o User maria novamente com as referências atribuídas.
    }
}
